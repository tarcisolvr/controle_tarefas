...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Tarefas<a href="{{route('tarefa.create')}}" class="float-end">Cadastrar nova tarefa</a><h1></h1>
                    <a href="{{route('tarefa.exportacao')}}" class="float-end">XLSX</a></div>
